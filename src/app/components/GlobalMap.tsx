    ...
    >
      {showHeader && (
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-b from-foreground to-foreground/60 bg-clip-text text-transparent mb-4">
      ...
      <div
        className={`relative aspect-[16/9] w-full bg-card/50 rounded-3xl border border-border overflow-hidden shadow-2xl flex items-center justify-center ${!showHeader ? "bg-transparent border-none shadow-none aspect-square" : ""}`}
      >
        {/* Interaction Layer */}
        <div
