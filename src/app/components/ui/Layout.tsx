...
import { Menu, X, ShoppingCart, Home, Gamepad2, Server, Sun, Moon } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground font-['Montserrat'] selection:bg-teal-500 selection:text-white transition-colors duration-800">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 flex-shrink-0 group">
            <img
              ...
              alt="AvixNode logo"
              className={clsx(
                "h-10 w-auto transition-all duration-200 group-hover:opacity-80",
            ...
            {animeNavItems.map((item) => (
              item.comingSoon ? (
                <button
                  ...
                  className={clsx(
                    "text-sm font-medium transition-colors hover:text-teal-500 cursor-pointer flex items-center gap-1.5",
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              className={clsx(
                "md:hidden w-9 h-9 flex items-center justify-center rounded-lg transition-all duration-200",
                !scrolled && isHomePage 
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="md:hidden bg-background border-t border-border absolute w-full z-40 shadow-[0_20px_40px_rgba(0,0,0,0.1)]"
            >
                    ...
                    >
                      {link.comingSoon ? (
                        <div
                          ...
                          className="flex items-center justify-between px-4 py-3.5 rounded-xl text-foreground/40 cursor-pointer hover:bg-foreground/5 transition-colors"
                        >
                        ...
                        >
                          {active && (
                            <span className="w-1.5 h-1.5 rounded-full bg-teal-500 dark:bg-teal-400 flex-shrink-0" />
                          )}
                          <span className="text-sm font-medium">
                            {link.name}
                          </span>
      ...
      <footer className="bg-secondary/30 border-t border-border pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-muted-foreground">
                ...
                <li
                  className="flex items-center gap-2 cursor-pointer hover:text-foreground/60 transition-colors"
                  onClick={() =>
          ...
          <div className="border-t border-border pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-muted-foreground/50">
            <p>
