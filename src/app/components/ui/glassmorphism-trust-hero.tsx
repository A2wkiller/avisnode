...
export default function HeroSection() {
    return (
        <div className="relative w-full text-foreground overflow-hidden font-sans transition-colors duration-800">
            {/* 
        SCOPED ANIMATIONS 
      */}
            <style>{`
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 pt-12 pb-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
                        ...
                        >
                            Host Servers<br />
                            <span className="bg-gradient-to-br from-foreground via-foreground to-teal-500 dark:to-teal-400 bg-clip-text text-transparent">
                                Without Limits
                            </span><br />
                            or Downtime
                        </h1>
                        ...
                        {/* Description */}
                        <p className="animate-fade-in delay-300 max-w-xl text-lg text-muted-foreground leading-relaxed">
                        ...
                        <div className="animate-fade-in delay-400 flex flex-col sm:flex-row gap-4">
                            <Button
                                ...
                                className="group inline-flex items-center justify-center gap-2 bg-teal-500 hover:bg-teal-400 text-sm font-semibold text-white dark:text-zinc-950 transition-all"
                            ...
                            <Button
                                ...
                                className="group inline-flex items-center justify-center gap-2 border border-border bg-card text-sm font-semibold text-foreground backdrop-blur-sm transition-colors hover:bg-accent"
                    ...
                    <div className="lg:col-span-5 space-y-6 lg:mt-12">
                        ...
                        {/* Stats Card */}
                        <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-border bg-card p-8 backdrop-blur-xl shadow-2xl transition-colors duration-800">
                            {/* Card Glow Effect */}
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="mt-8 flex flex-wrap gap-2">
                                    <div className="inline-flex items-center gap-1.5 rounded-full border border-teal-500/30 bg-teal-500/10 px-3 py-1 text-[10px] font-medium tracking-wide text-teal-600 dark:text-teal-300">
                                    ...
                                    <div className="inline-flex items-center gap-1.5 rounded-full border border-border bg-muted/50 px-3 py-1 text-[10px] font-medium tracking-wide text-muted-foreground">
                        ...
                        {/* Marquee Card */}
                        <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-border bg-card py-8 backdrop-blur-xl transition-colors duration-800">
                            <h3 className="mb-6 px-8 text-sm font-medium text-muted-foreground">Powered By Industry Leaders</h3>
