...
export default function GameHosting() {
  ...
  const handleOrderPlan = (plan: Plan) => {
    if (currentGame.outOfStock) {
            ...
            {currentPlans.slice(0, 3).map((plan, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={clsx(
                    "relative rounded-3xl border transition-all duration-300 group cursor-pointer",
                    isPopular
                      ? "bg-gradient-to-br from-teal-500/10 to-card border-teal-500/30 shadow-xl shadow-teal-500/10"
                ...
                >
                  ...
                  <div className="relative z-10 p-6 overflow-hidden rounded-3xl">
                    {/* Hover shine sweep */}
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-transparent via-foreground/[0.04] to-transparent pointer-events-none rounded-3xl"
                      initial={{ x: "-100%" }}
                      whileHover={{ x: "100%" }}
                    ...
                    <div className="flex items-start justify-between mb-6 relative z-10">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-foreground transition-colors duration-800">
                            {plan.name}
                          </h3>
                          <p className="text-muted-foreground text-xs transition-colors duration-800">
                    ...
                    <div className="mb-6 relative z-10">
                      <div className="flex items-baseline gap-1">
                        <span className="text-3xl font-bold text-foreground transition-colors duration-800">
                          {plan.price}
                        </span>
                        <span className="text-muted-foreground font-medium text-sm transition-colors duration-800">
                          /month
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-y-4 gap-x-3 mb-6 relative z-10">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-lg bg-foreground/5 flex items-center justify-center">
                          <MemoryStick className="w-4 h-4 text-teal-500 dark:text-teal-400" />
                        </div>
                        <span className="text-xs font-medium text-foreground/80 transition-colors duration-800">
                          {plan.ram}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-lg bg-foreground/5 flex items-center justify-center">
                          <HardDrive className="w-4 h-4 text-teal-500 dark:text-teal-400" />
                        </div>
                        <span className="text-xs font-medium text-foreground/80 transition-colors duration-800">
                          {plan.storage}
                        </span>
                    ...
                    <InteractiveHoverButton
                      text={currentGame.outOfStock ? "Out of Stock" : "Order Now"}
                      onClick={() => !currentGame.outOfStock && handleOrderPlan(plan)}
                      disabled={currentGame.outOfStock}
                      className={clsx(
                        "w-full bg-teal-500 text-white dark:text-black border-teal-600 hover:bg-teal-600",
                        currentGame.outOfStock && "opacity-50 cursor-not-allowed grayscale"
                      )}
                    />
                  </div>
                </motion.div>
